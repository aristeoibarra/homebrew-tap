...
class NextdnsBlocker < Formula
  ...
  url "https://files.pythonhosted.org/packages/source/n/nextdns-blocker/nextdns_blocker-5.4.0.tar.gz"
  sha256 "8e5a931858ecbd1ae8c489b6046a1a1fc90fe61d49cd0d395e06bacf92b7bbc3"
  license "MIT"
  ...
  resource "platformdirs" do
    url "https://files.pythonhosted.org/packages/source/p/platformdirs/platformdirs-4.5.1.tar.gz"
  ...
  resource "tzdata" do
    url "https://files.pythonhosted.org/packages/source/t/tzdata/tzdata-2025.3.tar.gz"
